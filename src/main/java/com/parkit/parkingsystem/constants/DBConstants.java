...
public class DBConstants {
	...
	public static final String GET_RECURRING_USER = "select VEHICLE_REG_NUMBER, OUT_TIME from ticket where VEHICLE_REG_NUMBER = ? and OUT_TIME is NOT null limit 1";
}
